...
var Calendar = (0, _createReactClass2['default'])({
  ...
  onKeyDown: function onKeyDown(event) {
    ...
    switch (keyCode) {
      ...
      case _KeyCode2['default'].HOME:
        this.setValue((0, _toTime.goStartMonth)(this.state.displayedValue));
        event.preventDefault();
        return 1;
      case _KeyCode2['default'].END:
        this.setValue((0, _toTime.goEndMonth)(this.state.displayedValue));
        event.preventDefault();
        return 1;
  ...
  onWeekDaysSelect: function onWeekDaysSelect(_ref) {
  ...
  onWeekDaysMouseEnter: function onWeekDaysMouseEnter(_ref2) {
  ...
  goTime: function goTime(direction, unit) {
    this.setValue((0, _toTime.goTime)(this.state.displayedValue, direction, unit));
  },
