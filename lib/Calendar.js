...
var Calendar = function (_React$Component) {
  ...
  Calendar.getDerivedStateFromProps = function getDerivedStateFromProps(nextProps, state) {
    ...
    if (!state.displayedValue) {
      var value = getMomentObjectIfValid(nextProps.value) || getMomentObjectIfValid(nextProps.defaultValue) || (0, _CalendarMixin.getNowByCurrentStateValue)(state.displayedValue, nextProps.multiple);
