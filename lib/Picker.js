...
var _initialiseProps = function _initialiseProps() {
  ...
  this.onCalendarSelect = function (value) {
    ...
    if (!props.multiple && (cause.source === 'keyboard' || cause.source === 'dateInputSelect' || !props.calendar.props.timePicker && cause.source !== 'dateInput' || cause.source === 'todayButton')) {
      _this2.close(_this2.focus);
    }
  ...
  this.setOpen = function (open, callback) {
    ...
    if (_this2.state.open !== open) {
      if (!('open' in _this2.props) || _this2.props.open === undefined) {
        _this2.setState({
          open: open
        }, callback);
      }
